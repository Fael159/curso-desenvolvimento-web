...
class Bd {
	...
	recuperarTodosRegistros() {
		...
		//recuperar todas as despesas cadastradas em locaSorage
		for(let i = 1; i <= id; i++) {
...
function cadastrarDispesas() {
	...
	if (despesa.validarDados()) {
		...
		document.getElementById('moda_btn').innerHTML = 'Voltar e preencher'
...
function carregaListaDespesa(despesas = Array(), filtro = false) {
	...
	if (despesas.length == 0 && filtro == true) {
		...
		document.getElementById('modal_titulo_div').className = 'modal-header text-danger'
		document.getElementById('modal_titulo').innerHTML = 'Erro na pesquisa'
		document.getElementById('modal_conteudo').innerHTML = 'Nenhuma despesa foi localizada com os filtros utilizados!'
		document.getElementById('moda_btn').innerHTML = 'Voltar'
		document.getElementById('moda_btn').className = 'btn btn-danger'
		document.getElementById('moda_btn2').className = 'd-none'

		//dialog de erro
		$('#modelPesquisa').modal('show')
	...
	//selecionar o elemento tbady da tabela
	...
	despesas.forEach(function(d) {
		...
		btn.onclick = function() {
			...
			document.getElementById('moda_btn').innerHTML = 'Cancelar'
			document.getElementById('moda_btn').className = 'btn btn-danger'
			document.getElementById('moda_btn2').innerHTML = 'Confirmar'
			document.getElementById('moda_btn2').className = 'btn btn-success'

			//dialog de erro
			$('#modelPesquisa').modal('show')

			let btnExcluir = document.getElementById('moda_btn2')
